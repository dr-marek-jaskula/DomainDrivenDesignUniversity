...
public sealed class EntityIdConverterGeneratorTests
{
    ...
    {
        //Act
        var actualResult = _entityIdConverterGenerator.GetGeneratedOutput(string.Empty);
...
public class EntityIdConverterAttribute : global::System.Attribute
{
    ...
    public void EntityIdConverterGenerator_ShouldGenerateEntityIdConverter()
    {
        ...
        //Act
        var actualResult = _entityIdConverterGenerator.GetGeneratedOutput(input);
    ...
    private static (string input, string output) GetEntityToGenerateId()
    {
        ...
        {
            [EntityIdConverter(IdName = nameof(ProductId), IdNamespace = "OtherNamespace.ProductIdNamespace"]

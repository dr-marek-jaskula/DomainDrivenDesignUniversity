...
public sealed class EntityIdComparerGeneratorTests
{
    ...
    {
        //Act
        var actualResult = _entityIdComparerGenerator.GetGeneratedOutput(string.Empty);
...
public class EntityIdComparerAttribute : global::System.Attribute
{
    ...
    public void EntityIdComparerGenerator_ShouldGenerateEntityIdComparer()
    {
        ...
        //Act
        var actualResult = _entityIdComparerGenerator.GetGeneratedOutput(input);
    ...
    private static (string input, string output) GetEntityToGenerateId()
    {
        ...
        {
            [EntityIdComparer(IdName = nameof(ProductId), IdNamespace = "OtherNamespace.ProductIdNamespace"]

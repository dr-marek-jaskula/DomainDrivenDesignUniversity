...
{
    private const string EntityIdConverterAttributeMetadataName = "System.EntityIdConverterAttribute";
    private const string EntityIdConverterAttributeFileName = "EntityIdConverterAttribute.g.cs";

    public const string EntityIdConverterAttribute = Header + $$$"""
...
/// <summary>
/// Add to entity configurations to indicate that entity id Converter structure should be generated
/// </summary>
...
public class EntityIdConverterAttribute : global::System.Attribute
{
...
""";
    ...
    private static IncrementalValuesProvider<EntityIdConverterToGenerateEntry> RegisterSourceProvider(IncrementalGeneratorInitializationContext context)
    {
        ...
        (
            EntityIdConverterAttributeFileName,
            SourceText.From(EntityIdConverterAttribute, Encoding.UTF8))
        );

        return context
            .SyntaxProvider
            .ForAttributeWithMetadataName(EntityIdConverterAttributeMetadataName, Selectors.IsClass, MapToEntityIdConverterToGenerate)
    ...
    private static EntityIdConverterToGenerateEntry MapToEntityIdConverterToGenerate(GeneratorAttributeSyntaxContext context, CancellationToken cancellationToken)
    {
        ...
        AttributeData attribute = context.Attributes.First(a => EntityIdConverterAttributeMetadataName.Contains(a.AttributeClass?.Name));

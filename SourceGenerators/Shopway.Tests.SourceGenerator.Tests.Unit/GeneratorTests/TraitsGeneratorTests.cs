...
public sealed class TraitsGeneratorTests
{
    private readonly TraitsGenerator _traitsGenerator;

    public TraitsGeneratorTests()
    {
        _traitsGenerator = new TraitsGenerator();
    }

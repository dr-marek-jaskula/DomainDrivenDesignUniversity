...
public class FlatDataTransferObject : IDictionary<string, string>
{
    protected readonly Dictionary<string, string> _dictionary = [];

    public FlatDataTransferObject()
    {
    }

    protected FlatDataTransferObject(FlatDataTransferObject dataTransferObject)
    {
        _dictionary = dataTransferObject._dictionary;
    }

    public static FlatDataTransferObject Create<TType>(TType entity, IList<string> properties)
        where TType : class, IEntity
    {
        var dictionaryResponse = new FlatDataTransferObject();
    ...
    public FlatDataTransferObject AddIf(bool condition, string key, string value)
    {

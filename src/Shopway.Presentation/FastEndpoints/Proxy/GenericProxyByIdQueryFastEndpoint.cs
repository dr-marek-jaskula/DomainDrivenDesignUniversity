...
public sealed class GenericProxyByIdQueryFastEndpoint(ISender sender, IMediatorProxyService genericMappingService, IAuthorizationService authorizationService)
    : Endpoint<GenericProxyByIdQuery, Results<Ok<DataTransferObjectResponse>, ProblemHttpResult, ForbidHttpResult>>
{
    ...
    private const string _name = nameof(GenericProxyByIdQueryFastEndpoint);

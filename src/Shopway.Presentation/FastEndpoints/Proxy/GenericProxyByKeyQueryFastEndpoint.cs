...
public sealed class GenericProxyByKeyQueryFastEndpoint(ISender sender, IMediatorProxyService genericMappingService, IAuthorizationService authorizationService)
    : Endpoint<GenericProxyByKeyQuery, Results<Ok<DataTransferObjectResponse>, ProblemHttpResult, ForbidHttpResult>>
{
    ...
    private const string _name = nameof(GenericProxyByKeyQueryFastEndpoint);

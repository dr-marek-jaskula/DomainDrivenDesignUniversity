...
internal sealed class ProductSelectQuerySpecification<TResposnse> : SpecificationWithMappingBase<Product, ProductId, TResposnse>
{
    private ProductSelectQuerySpecification() : base()
    {
    }
    ...
    {
        var specification = new ProductSelectQuerySpecification<TResposnse>();

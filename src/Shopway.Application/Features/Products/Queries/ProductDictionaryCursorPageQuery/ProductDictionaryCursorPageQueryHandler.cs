...
internal sealed class ProductDictionaryCursorPageQueryHandler(IProductRepository productRepository)
    : ICursorPageQueryHandler<ProductDictionaryCursorPageQuery, DictionaryResponseEntry<ProductKey>, ProductDictionaryStaticFilter, ProductDynamicSortBy, CursorPage>
{
    private readonly IProductRepository _productRepository = productRepository;

    public async Task<IResult<CursorPageResponse<DictionaryResponseEntry<ProductKey>>>> Handle(ProductDictionaryCursorPageQuery pageQuery, CancellationToken cancellationToken)
    {
